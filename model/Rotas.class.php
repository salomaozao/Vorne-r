...
Class Rotas{
	...
	static function pag_NovosProdutosADM(){
		return self::get_SiteADM() . '/adm_novos_produtos';
	}

	static function pag_EditarProdutosADM(){
		return self::get_SiteADM() . '/adm_editar_produtos';
	}

	static function pag_DeletarProdutosADM(){
		return self::get_SiteADM() . '/adm_deletar_produtos';
	}

	static function pag_ImgProdutosADM(){
	...
	static function pag_EditarClientesADM(){
		return self::get_SiteADM() . '/adm_editar_clientes';
	}
	...
	static function pag_RecoveryADM(){
		return self::get_SiteADM() . '/adm_recovery';
	}


	static function ImageLink($img,$largura,$altura){
		$imagem = self::get_ImageURL() ."{$img}";  //"thumb.php?src={$img}&w={$largura}&h={$altura}&zc=1"
		return $imagem;
	}
	...
	static function get_Pagina(){
		if(isset($_GET['pag'])){ //verifica se há algum valor na url
